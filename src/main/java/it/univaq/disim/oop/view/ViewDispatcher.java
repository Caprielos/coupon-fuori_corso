package it.univaq.disim.oop.view;

import it.univaq.disim.oop.controller.DataInitializable;
...
public class ViewDispatcher {
    ...
    public void loggedIn(Utente user) {

        try {
            Scene scene;
            View<Utente> layoutView;
            DataInitializable<Utente> layoutController;
            layoutView = loadView("layout");
